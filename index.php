...
<head>
    ...
    <link rel="stylesheet" href="/assets/styles/css/mainpage.css">

    <script defer src="/assets/js/mainpage-top-slider.js"></script>
</head>
<body>
        ...
        <div class="container-1440">
            <div class="page-header__inner-container">
                ...
                <a href="/" class="logo-wrapper" title="Перейти на главную страницу">
                    <img src="/upload/images/logo.jpg" alt="Логотип Sweet World">
                </a>
    
                <nav class="page-header__right-navigation">
                    <a href="/personal/" title="Перейти в личный кабинет" class="page-header__site-navigation-link">
                    ...
                    <a href="/cart/" title="Перейти в корзину" class="page-header__site-navigation-link">
                    ...
                    <a href="/liked/" title="Перейти в избранные товары" class="page-header__site-navigation-link">
                ...
                <nav class="page-header__site-navigation">
                    <a href="/dostavka/" class="site-navigation__link">Доставка</a>
                    <a href="/o-nas/" class="site-navigation__link">О нас</a>
                    <a href="/katalog/" class="site-navigation__link">Каталог</a>
                    <a href="/otzivi/" class="site-navigation__link">Отзывы</a>
                    <a href="/kontakty/" class="site-navigation__link">Контакты</a>
                </nav>
            </div>
        </div>
    </header>
            ...
            <div class="swiper mainpage-top-slider">
                ...
                <div class="mainpage-top-slider__content">
                    ...
                    <div class="mainpage-top-slider__search-catalog-wrapper">
                        ...
                        <a href="/katalog/" class="mainpage-top-slider__catalog-btn">Каталог</a>
                    </div>
                </div>
            </div>
        </section>
