...
<div class="container-1440">
    <div class="catalog-top">
        <h1 class="catalog__title">Шоколад</h1>
    ...
    <div class="catalog-bottom">
        <div class="catalog-left">
            ...
            <nav class="nav">
                <ul class="catalog-left-list">
                    ...
                    <li class="catalog-left__item">
                        <a href="index.php" class="catalog-left__item__title">
                            шоколад
                        </a>
                    </li>
                    <li class="catalog-left__item">
        ...
        <div class="catalog-right">
            <div class="catalog-right-block">
                <h2 class="catalog-block__title">Батончики</h2>
                <div class="courusel">
            ...
            <div class="catalog-right-block">
                <h2 class="catalog-block__title">Драже</h2>
                <div class="courusel">
                    <div class="caurusel-block">
                        <ul class="catalog-right-block-list">
                            <li class="catalog-right-block-list">
            ...
            <div class="catalog-right-block">
                <h2 class="catalog-block__title">Фигурный</h2>
                <div class="courusel">
                    <div class="caurusel-block">
                        <ul class="catalog-right-block-list">
                            <li class="catalog-right-block-list">
            ...
            <div class="catalog-right-block">
                <h2 class="catalog-block__title">Молочный</h2>
                <div class="courusel">
                    <div class="caurusel-block">
                        <ul class="catalog-right-block-list">
                            <li class="catalog-right-block-list">
            ...
            <div class="catalog-right-block">
                <h2 class="catalog-block__title">Горький</h2>
                <div class="courusel">
                    <div class="caurusel-block">
                        <ul class="catalog-right-block-list">
                            <li class="catalog-right-block-list">
            ...
            <div class="catalog-right-block">
                <h2 class="catalog-block__title">Белый</h2>
                <div class="courusel">
                    <div class="caurusel-block">
                        <ul class="catalog-right-block-list">
                            <li class="catalog-right-block-list">
